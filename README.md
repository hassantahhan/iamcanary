...
The Lambda function demonstrates a concept which can be reversed to test when a permission is accedentaly extended. In this case, the canary routinely attempts particular API actions that should be denied.<br/> 
